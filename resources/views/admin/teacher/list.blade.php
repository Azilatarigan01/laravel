        ...
        <div class="card-body p-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 d-flex justify-content-end">
                    <a href="{{ url('admin/teacher/add') }}" class="btn btn-primary text-white">Add New Teacher</a>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped table-hover">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" class="text-center align-middle" style="min-width: 150px;">Date of Joining</th>
                            <th scope="col" class="text-center align-middle" style="min-width: 150px;">Mobile Number</th>
                            <th scope="col" class="text-center align-middle" style="min-width: 150px;">Marital Status</th>
                            <th scope="col" class="text-center align-middle" style="min-width: 150px;">Address</th>
                    ...
                    <tbody>
                        @foreach ($getRecords as $record)
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    {{ $record->marital_status == 0 ? 'Single' : 'Married' }}
                                </td>
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ url('admin/teacher/edit', $record->id) }}" class="btn btn-sm btn-primary me-1">Edit</a>
                                        <form action="{{ route('teacher.delete', $record->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this teacher?');">
                                            @csrf
                                            @method('DELETE')
