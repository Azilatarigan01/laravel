        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.assignments.update', $assignment->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" value="{{ $assignment->assignments_date }}" name="assignments_date" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" value="{{ $assignment->submission_date }}" name="submission_date" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea id="inputDescription" name="description" class="form-control" style="height: 300px">{{ $assignment->description }}</textarea>
                    @error('description')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
