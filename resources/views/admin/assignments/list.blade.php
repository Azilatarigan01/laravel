        ...
        <div class="card-body p-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    <a href="{{ route('admin.assignments.add') }}" class="btn btn-primary">Add New Assignment</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-flex justify-content-center">
                                    <a href="{{ route('admin.assignments.edit', $record->id) }}" class="btn btn-sm btn-primary me-1">Edit</a>
                                    <form action="{{ route('admin.assignments.delete', $record->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this assignment?');">
                                        @csrf
                                        @method('DELETE')
